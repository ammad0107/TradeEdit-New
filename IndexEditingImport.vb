Public Class IndexEditingImport
    Private Sub IndexEditingImport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            With DataGridView1
                ...
                Dim YE As Integer = Convert.ToInt32(baseyear).ToString()
                'Dim baseyear = Class1.BaseYear
                ...
                Me.Index_importTableAdapter.GetAllIndexportOldBase(Me.TradeStatisticsDataSet.index_import, YE, month, basetype)
    ...
    Private Sub TextBoxSearch_TextChanged(sender As Object, e As EventArgs) Handles TextBoxSearch.TextChanged
        Try
            Me.IndeximportBindingSource.Filter = "CODE Like '%" & TextBoxSearch.Text & "%'"
            ...
            Try
                ...
                If e.RowIndex <= .Rows.Count - 1 Then
                    ...
                    If e.ColumnIndex = .Columns.IndexOf(.Columns("QUANTITY1DataGridViewTextBoxColumn")) Then
                        ...
                        Me.Index_importTableAdapter.UpdateQuantityIndexImport(GetQty, YY, MM, CODE, BASE)
                        Me.Index_importTableAdapter.UpdateUnitValIndexImport(YY, MM, CODE, BASE)

                        Try


                            Dim unitvalue As Integer = Me.Index_importTableAdapter.GetunitValueIndexImport(YY, MM, CODE, BASE)
